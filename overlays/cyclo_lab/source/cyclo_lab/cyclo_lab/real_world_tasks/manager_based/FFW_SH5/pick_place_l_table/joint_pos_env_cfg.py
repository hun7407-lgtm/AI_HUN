...
from cyclo_lab.real_world_tasks.manager_based.FFW_SH5.pick_place_l_table.pick_place_sh5_env_cfg import PickPlaceLTableSH5EnvCfg
...
@configclass
class FFWSH5PickPlaceLTableEnvCfg(PickPlaceLTableSH5EnvCfg):
