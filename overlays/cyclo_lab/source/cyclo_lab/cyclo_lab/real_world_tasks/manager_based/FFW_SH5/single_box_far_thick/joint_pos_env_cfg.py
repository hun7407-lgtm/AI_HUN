...
from cyclo_lab.real_world_tasks.manager_based.FFW_SG2.single_box_far_thick.mdp import single_box_far_thick_events
from cyclo_lab.real_world_tasks.manager_based.FFW_SH5._shared import attach_sh5_robot_and_sensors
from cyclo_lab.real_world_tasks.manager_based.FFW_SH5.single_box_far_thick.single_box_far_thick_sh5_env_cfg import SingleBoxFarThickSH5EnvCfg
from cyclo_lab.assets.object.table_prim import TABLE_FRONT_CFG, TABLE_LEFT_CFG
from cyclo_lab.assets.object.thick_cardboard_box import THICK_CARDBOARD_BOX_CFG
...
class EventCfg:
    ...
    randomize_scene = EventTerm(
        func=single_box_far_thick_events.randomize_single_box_far_scene,
        mode="reset",
        params={
...
@configclass
class FFWSH5SingleBoxFarThickEnvCfg(SingleBoxFarThickSH5EnvCfg):
    def __post_init__(self):
        ...
        self.scene.cardboard_box = THICK_CARDBOARD_BOX_CFG.replace(prim_path="{ENV_REGEX_NS}/CardboardBox")
