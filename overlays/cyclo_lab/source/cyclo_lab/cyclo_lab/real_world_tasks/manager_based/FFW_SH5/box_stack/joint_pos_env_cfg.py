...
from cyclo_lab.real_world_tasks.manager_based.FFW_SG2.box_stack.mdp import box_stack_events
from cyclo_lab.real_world_tasks.manager_based.FFW_SH5._shared import attach_sh5_robot_and_sensors
from cyclo_lab.real_world_tasks.manager_based.FFW_SH5.box_stack.box_stack_sh5_env_cfg import BoxStackSH5EnvCfg
...
class EventCfg:
    ...
    randomize_scene = EventTerm(
        func=box_stack_events.randomize_l_table_scene,
        mode="reset",
        params={
...
@configclass
class FFWSH5BoxStackEnvCfg(BoxStackSH5EnvCfg):
