...
parser.add_argument("--robot_type", type=str, default="keyboard", choices=['OMY', 'FFW_SG2', 'FFW_SH5'], help="Type of robot to use for teleoperation.")
...
def main():
    ...
    elif args_cli.robot_type == "FFW_SH5":
        from dds_sdk.ffw_sh5_sdk import FFWSH5Sdk
        teleop_interface = FFWSH5Sdk(env, mode='record')
    else:
        raise ValueError(
            f"Invalid device interface '{args_cli.robot_type}'. Supported: 'OMY', 'FFW_SG2', 'FFW_SH5'."
        )
